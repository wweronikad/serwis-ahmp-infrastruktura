...
// All panoramas served from /panoramy/; gallery fallbacks only for tczew, torun, ziebice
const CITY_PANORAMAS = {
  biecz:               [asset('/panoramy/biecz.webp'),              'a'],
  bochnia:             [asset('/panoramy/bochnia.webp'),            'b'],
  brzeg:               [asset('/panoramy/brzeg.webp'),              'c'],
  bydgoszcz:           [asset('/panoramy/bydgoszcz.webp'),          'd'],
  chelmno:             [asset('/panoramy/chelmno.webp'),            'a'],
  chojnice:            [asset('/panoramy/chojnice.webp'),           'b'],
  elblag:              [asset('/panoramy/elblag.webp'),             'c'],
  fordon:              [asset('/panoramy/fordon.webp'),             'd'],
  gizycko:             [asset('/panoramy/gizycko.webp'),            'a'],
  grudziadz:           [asset('/panoramy/grudziadz.webp'),          'b'],
  'jelenia-gora':      [asset('/panoramy/jelenia-gora.webp'),       'c'],
  ketrzyn:             [asset('/panoramy/ketrzyn.webp'),            'd'],
  koronowo:            [asset('/panoramy/koronowo.webp'),           'a'],
  kwidzyn:             [asset('/panoramy/kwidzyn.webp'),            'b'],
  legnica:             [asset('/panoramy/legnica.webp'),            'c'],
  'lidzbark-warminski':[asset('/panoramy/lidzbark-warminski.webp'), 'd'],
  milicz:              [asset('/panoramy/milicz.webp'),             'a'],
  mragowo:             [asset('/panoramy/mragowo.webp'),            'b'],
  namyslow:            [asset('/panoramy/namyslow.webp'),           'c'],
  niemcza:             [asset('/panoramy/niemcza.webp'),            'd'],
  'nowy-sacz':         [asset('/panoramy/nowy-sacz.webp'),          'a'],
  olawa:               [asset('/panoramy/olawa.webp'),              'b'],
  ostroda:             [asset('/panoramy/ostroda.webp'),            'c'],
  puck:                [asset('/panoramy/puck.webp'),               'd'],
  raciborz:            [asset('/panoramy/raciborz.webp'),           'a'],
  'sroda-slaska':      [asset('/panoramy/sroda-slaska.webp'),       'b'],
  'stary-sacz':        [asset('/panoramy/stary-sacz.webp'),         'c'],
  strzegom:            [asset('/panoramy/strzegom.webp'),           'd'],
  strzelin:            [asset('/panoramy/strzelin.webp'),           'a'],
  swidnica:            [asset('/panoramy/swidnica.webp'),           'b'],
  swiecie:             [asset('/panoramy/swiecie.webp'),            'c'],
  tarnow:              [asset('/panoramy/tarnow.webp'),             'd'],
  'torun-ii':          [asset('/panoramy/torun-ii.webp'),           'a'],
  trzebnica:           [asset('/panoramy/trzebnica.webp'),          'b'],
  wieliczka:           [asset('/panoramy/wieliczka.webp'),          'c'],
  wloclawek:           [asset('/panoramy/wloclawek.webp'),          'd'],
  wroclaw:             [asset('/panoramy/wroclaw.webp'),            'a'],
  'zabkowice-slaskie': [asset('/panoramy/zabkowice-slaskie.webp'),  'b'],
  zamosc:              [asset('/panoramy/zamosc.webp'),             'c'],
  // Gallery fallbacks — panoramas not yet provided
  tczew:   [asset('/galeria/tczew/tczew_panorama_od_wschodu_1855.webp'), 'b'],
  torun:   [asset('/galeria/torun/torun_plan_widok_1641.webp'),          'c'],
  ziebice: [asset('/galeria/ziebice/ziebice_panorama_od_sw_1738.webp'),  'd'],
}
...
const ABOUT_CARDS = [
  {
    ...
    text: 'Projekt badawczy zapoczątkowany w 1993 r. przez prof. Antoniego Czacharowskiego (UMK Toruń) — dotąd atlasy 47 miast, zespoły w Toruniu, Wrocławiu i Krakowie.',
...
const EVENTS = [
  ...
  { year: '1993', text: 'Prof. Antoni Czacharowski inicjuje w UMK Toruń projekt polskiej edycji atlasu; ukazuje się pierwszy zeszyt (Elbląg).' },
  { year: 'DZIŚ', text: 'Atlasy 47 polskich miast, współpraca z zespołami w Toruniu, Wrocławiu i Krakowie.', hi: true },
]
