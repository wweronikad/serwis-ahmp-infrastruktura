...
const CITY_PANORAMAS = {
  ...
  milicz:              [asset('/panoramy/milicz.png'),             'a'],
  mragowo:             [asset('/panoramy/mragowo.png'),            'b'],
  namyslow:            [asset('/panoramy/namyslow.png'),           'c'],
  niemcza:             [asset('/panoramy/niemcza.png'),            'd'],
  'nowy-sacz':         [asset('/panoramy/nowy-sacz.png'),          'a'],
  olawa:               [asset('/panoramy/olawa.png'),              'b'],
  ostroda:             [asset('/panoramy/ostroda.png'),            'c'],
  puck:                [asset('/panoramy/puck.png'),               'd'],
  raciborz:            [asset('/panoramy/raciborz.png'),           'a'],
  'sroda-slaska':      [asset('/panoramy/sroda-slaska.png'),       'b'],
  'stary-sacz':        [asset('/panoramy/stary-sacz.png'),         'c'],
  strzegom:            [asset('/panoramy/strzegom.png'),           'd'],
  strzelin:            [asset('/panoramy/strzelin.png'),           'a'],
  swidnica:            [asset('/panoramy/swidnica.png'),           'b'],
  swiecie:             [asset('/panoramy/swiecie.png'),            'c'],
  tarnow:              [asset('/panoramy/tarnow.png'),             'd'],
  'torun-ii':          [asset('/panoramy/torun-ii.jpg'),           'a'],
  trzebnica:           [asset('/panoramy/trzebnica.png'),          'b'],
  wieliczka:           [asset('/panoramy/wieliczka.png'),          'c'],
  wloclawek:           [asset('/panoramy/wloclawek.jpg'),          'd'],
  wroclaw:             [asset('/panoramy/wroclaw.png'),            'a'],
  'zabkowice-slaskie': [asset('/panoramy/zabkowice-slaskie.png'),  'b'],
  zamosc:              [asset('/panoramy/zamosc.png'),             'c'],
