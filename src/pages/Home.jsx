...
const CITY_PANORAMAS = {
  ...
  milicz:              [asset('/panoramy/milicz.jpg'),             'a'],
  mragowo:             [asset('/panoramy/mragowo.jpg'),            'b'],
  namyslow:            [asset('/panoramy/namyslow.jpg'),           'c'],
  niemcza:             [asset('/panoramy/niemcza.jpg'),            'd'],
  'nowy-sacz':         [asset('/panoramy/nowy-sacz.jpg'),          'a'],
  olawa:               [asset('/panoramy/olawa.jpg'),              'b'],
  ostroda:             [asset('/panoramy/ostroda.jpg'),            'c'],
  puck:                [asset('/panoramy/puck.jpg'),               'd'],
  raciborz:            [asset('/panoramy/raciborz.jpg'),           'a'],
  'sroda-slaska':      [asset('/panoramy/sroda-slaska.jpg'),       'b'],
  'stary-sacz':        [asset('/panoramy/stary-sacz.jpg'),         'c'],
  strzegom:            [asset('/panoramy/strzegom.jpg'),           'd'],
  strzelin:            [asset('/panoramy/strzelin.jpg'),           'a'],
  swidnica:            [asset('/panoramy/swidnica.jpg'),           'b'],
  swiecie:             [asset('/panoramy/swiecie.jpg'),            'c'],
  tarnow:              [asset('/panoramy/tarnow.jpg'),             'd'],
  'torun-ii':          [asset('/panoramy/torun-ii.jpg'),           'a'],
  trzebnica:           [asset('/panoramy/trzebnica.jpg'),          'b'],
  wieliczka:           [asset('/panoramy/wieliczka.jpg'),          'c'],
  wloclawek:           [asset('/panoramy/wloclawek.jpg'),          'd'],
  wroclaw:             [asset('/panoramy/wroclaw.jpg'),            'a'],
  'zabkowice-slaskie': [asset('/panoramy/zabkowice-slaskie.jpg'),  'b'],
  zamosc:              [asset('/panoramy/zamosc.jpg'),             'c'],
